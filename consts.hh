...
const unsigned int FEV_EV=0, INF_EV=1, SET_EV=2;                 // Characterise event types (future event/infection/settime/external)
const unsigned int EXT_EV=3, XIFEV_EV=4, XPFEV_EV=5;
