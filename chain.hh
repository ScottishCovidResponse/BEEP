...
class Chain                                               // Stores all the things related to an MCMC chain
{
	public:
		...
		double invT;                                          // The inverse temperature (used for MC3)

		Jump jump;                                            // Stores information about jumping in parameter space
	...
	private:
		...
		double add_individuals();
		double remove_individuals();
		...
		vector <unsigned int> nboth_sysceptible_list;  
