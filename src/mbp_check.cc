/// This routines checks that Mbp is working correctly
...
void Mbp::check_MBP()
{
	...
	cout << obsmodel.calculate(initial) << " initial error" << endl;
	...
	for(auto th = 0u; th < nparam; th++){
		cout << mpi.core << model.param[th].name << " " << nac[th]/ntr[th] << " " << jump[th] << "" << endl;
	}
}
